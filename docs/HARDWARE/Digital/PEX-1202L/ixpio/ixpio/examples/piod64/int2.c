/* Example of interrupt handling for PIO-D64. This program configures
   driver to send signals in differnet signal id for two interrupt
   channels.
...
{
	static unsigned int sig_tmrirq, sig_extirq, unknown;
