...
/* File level history (record changes for this file here.)
   ...
   v 0.0.0 25 September 2006 by Reed Lai
     create */
/*
PIS730_IDIOA    IDIO 0 ~ IDIO 7 
PIS730_IDIOB    IDIO 8 ~ IDIO 15 
PIS730_DIOA     DIO 0 ~ DIO 7 
PIS730_DIOB     DIO 8 ~ DIO 15 
*/
...
int main()
{
	...
	while (getchar() == 10) {
                ...
                if (PIODA_Digital_Output(fd, PIS730_IDIOB, do_data)) return FAILURE;
		usleep(5000); /* 5ms for relay operating time */

                if (PIODA_Digital_Input(fd, PIS730_IDIOB, &di_data)) return FAILURE;
