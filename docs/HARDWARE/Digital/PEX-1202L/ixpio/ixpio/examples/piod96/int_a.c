/* Example of interrupt handle for PIO-D96 with PIO/PISO Static Libary.
...
/* File level history (record changes for this file here.)
   ...
   v 0.0.0 7 Sep 2007 by Golden Wang
     create, */
...
int main()
{
  ...
  if (PIODA_IntInstall(fd, sig_handler, MY_SIG, PIOD56_24_P2C0, 0)) return FAILURE;
